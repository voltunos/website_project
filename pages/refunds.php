...
$query = "SELECT * FROM pedido WHERE estado = 'Esperando reembolso'";
...
<head>
    <title>Devoluciones y reembolsos</title>
...
<body>
    ...
    <span class="edit-title">Devoluciones y reembolsos</span>
    <div class="order-body">
        <div class="orders">
            ...
            foreach($pedidos as $pedido) {
                ...
                echo '<span class="order-text"><b>ID usuario:</b> '.$pedido['id_usuario'].'</span>';
        ...
        <div class="order-filters">
            <div class="order-filter-box">
                ...
                <hr class="filter-hr">
                <span class="filter-text">No hay ningún tipo de filtro disponible.</span>
            </div>
        </div>
    </div>
</body>