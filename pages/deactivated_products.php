...
$stmt = $pdo->prepare("SELECT * FROM productos WHERE activo = 0");
$stmt->execute();
...
<head>
    <title>Productos desactivados</title>
...
<body>
    ...
    <span class="edit-title">Productos desactivados</span>
     <?php
    if ($error) {
    ...
    <div class="reduced-space">
        ...
        foreach($productos as $producto) {
            ...
            echo '<input type="hidden" name="id_producto" value="'.$producto['id_producto'].'">';
            echo '<button class="product-edit-activatebutton" type="submit">Activar producto</button>';
            echo '</form>';
            echo '</div>';
            echo '</div>';
        ...
        <div class="product-edit-more">
            ...
            <a href="products.php"><span class="product-edit-additional">Productos activados</span><img src="../images/activated.png" class="icon"></a>
        </div>
    </div>
</body>