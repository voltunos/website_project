...
<body>
    ...
    <form class="direction-form" action="add_product_process.php" enctype="multipart/form-data" method="POST">
        <div class="account-form-start">
            <span class="account-form-title">Agregar producto</span>
        </div>
        <hr class="account-hr">
        ...
        <div class="account-form-info">
            ...
            <input class="account-form-input" type="text" name="precio" placeholder="Precio" required>
        ...
        <div class="account-form-info">
            ...
            <input class="account-form-input" type="text" name="descripcion" placeholder="Descripción">
